...
const STYLEBOX_MARGINS := {
	...
	"res://resources/ui/styleboxes/panel_tooltip.tres": 20.0,
...
func _run() -> void:
	...
	_assert_theme_stylebox(theme.get_stylebox("panel", "tooltip") as StyleBoxTexture, "Theme tooltip panel", 20.0)
